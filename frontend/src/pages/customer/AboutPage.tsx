...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <h1 className="mt-2 font-display text-4xl text-brand-900">Mây Vegan</h1>
      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-3">
        <div className="rounded-2xl border border-[var(--border-subtle)] p-5">
          ...
          <p className="text-sm font-semibold text-brand-900">Thuần chay</p>
        ...
        <div className="rounded-2xl border border-[var(--border-subtle)] p-5">
          ...
          <p className="text-sm font-semibold text-brand-900">Tận tâm</p>
      ...
      <div className="mt-10 flex items-start gap-3 rounded-2xl bg-cream-100 p-5">
        ...
        <div className="text-sm">
          <p className="font-medium text-brand-900">12 Nguyễn Huệ, Quận 1, TP. Hồ Chí Minh</p>
